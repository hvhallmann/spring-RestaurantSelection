...
public class JdbcOwnerRepositoryImpl implements OwnerRepository {
    ...
    @Autowired
    public JdbcOwnerRepositoryImpl(DataSource dataSource, NamedParameterJdbcTemplate namedParameterJdbcTemplate, JdbcTemplate jdbcTemplate) {
    ...
    public Collection<Owner> findAll() throws DataAccessException {
        ...
        owners.addAll(this.jdbcTemplate.query(
            "SELECT last_name FROM owners ORDER BY last_name,first_name",
            BeanPropertyRowMapper.newInstance(Owner.class)));
